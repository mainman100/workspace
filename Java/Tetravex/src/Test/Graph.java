...
public class Graph
{
	...
	public Graph(Board c)
	{
		...
		solution=new Board(size,0);//New empty Board
	...
	/*	for(int i=0;i<tiles.length;i++)//remember to change directions counts
		...
		for(int i=0;i<size;i++)
			...
			{
				c.getEvaluatedBoard()[i][j]=tiles[result[Count]];
				c.getMixedBoard()[i][j]=null;
				Count++;
			}
	}
	...
	public static void main(String[]args)
	{
		...
		Board c=new Board(scan.nextInt(),0);
